...
| 📄 Full Analysis Report | [`Olist_Analysis_Report.docx`](report/Olist_Analysis_Report.docx) |
...
├── report/
│   └── Olist_Analysis_Report.docx         # Written report — problem, approach, insights, recommendations
├── assets/
